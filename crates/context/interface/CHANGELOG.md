...
## [9.0.1](https://github.com/Soubhik-10/revm/compare/revm-context-interface-v9.0.0...revm-context-interface-v9.0.1) - 2025-07-28

### Fixed

- swapped comments for db and db_mut methods in JournalTr trait ([#2774](https://github.com/Soubhik-10/revm/pull/2774))
