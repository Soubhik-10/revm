...
## [8.1.1](https://github.com/Soubhik-10/revm/compare/op-revm-v8.1.0...op-revm-v8.1.1) - 2025-07-28

### Fixed

- nonce changed is not reverted in journal if fail due to insufficient balance ([#2805](https://github.com/Soubhik-10/revm/pull/2805))

### Other

- reuse global crypto provide idea ([#2786](https://github.com/Soubhik-10/revm/pull/2786))
- add rust-version and note about MSRV ([#2789](https://github.com/Soubhik-10/revm/pull/2789))
- add OnceLock re-export with no_std support ([#2787](https://github.com/Soubhik-10/revm/pull/2787))
- Add dyn Crypto trait to PrecompileFn ([#2772](https://github.com/Soubhik-10/revm/pull/2772))
