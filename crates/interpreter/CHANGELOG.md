...
## [25.0.0](https://github.com/Soubhik-10/revm/compare/revm-interpreter-v24.0.0...revm-interpreter-v25.0.0) - 2025-07-28

### Other

- fix inspector, cleanup loop ([#2797](https://github.com/Soubhik-10/revm/pull/2797))
- start InstructionResult at 1 ([#2802](https://github.com/Soubhik-10/revm/pull/2802))
- fix typos ([#2800](https://github.com/Soubhik-10/revm/pull/2800))
- improve inspector loop ([#2776](https://github.com/Soubhik-10/revm/pull/2776))
- add rust-version and note about MSRV ([#2789](https://github.com/Soubhik-10/revm/pull/2789))
- collapse debug info for interpreter macros ([#2780](https://github.com/Soubhik-10/revm/pull/2780))
# Changelog
All notable changes to this project will be documented in this file.
